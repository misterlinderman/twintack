...
// Increase execution time for large file processing - Added 2024-12-19
@ini_set('max_execution_time', 300); // 5 minutes
@ini_set('max_input_time', 300);     // 5 minutes for input processing

// TwinTack Debug Configuration - Added 2025-08-11 12:55:36
define('WP_DEBUG', true);
define('WP_DEBUG_LOG', true);
define('WP_DEBUG_DISPLAY', false);
// End TwinTack Debug Configuration
