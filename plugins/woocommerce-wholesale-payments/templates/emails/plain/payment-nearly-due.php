 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce-wholesale-payments/emails/plain/payment-nearly-due.php.
 *
...
<?php
esc_html_e(
    'Please ensure your payment is processed before the due date to maintain uninterrupted access to your account.',
