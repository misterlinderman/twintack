 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce-wholesale-payments/emails/payment-due-today.php.
 *
...
$email_styles_settings = WPay_Emails::email_styles_settings();
...
<div id="body_content_inner">
    <p class="wpay-text">
        ...
        echo esc_html(
            sprintf(
                ...
                __( 'A payment to %1$s is due today', 'woocommerce-wholesale-payments' ),
                $site_title
            )
        );
        ?>
    ...
    <p class="wpay-text">
        <?php esc_html_e( 'Please ensure your payment is processed today to maintain uninterrupted access to your account.', 'woocommerce-wholesale-payments' ); ?>
    </p>
