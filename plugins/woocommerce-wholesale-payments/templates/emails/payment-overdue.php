<?php
/**
 * Customer Wholesale Payment Overdue Email
 *
 * This template can be overridden by copying it to yourtheme/woocommerce-wholesale-payments/emails/payment-overdue.php.
 *
...
<div id="body_content_inner">
    ...
    <p class="wpay-text">
        <?php esc_html_e( 'Please ensure your payment is processed as soon as possible to maintain uninterrupted access to your account.', 'woocommerce-wholesale-payments' ); ?>
    </p>
...
<div id="template_footer" class="wpay-footer">
    ...
    <div class="wpay-powered-by">
        <div class="wpay-powered-by-content">
            ...
            <a href="<?php echo esc_url( WPay_Emails::get_utm_url( 'payment-overdue-template' ) ); ?>">
                <img
