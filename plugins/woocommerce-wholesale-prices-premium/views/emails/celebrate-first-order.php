<table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
    <tr>
        <td align="center" valign="top" class="greetings-content" style="color: #384860; padding-left: 50px; padding-right: 50px;">
            <h1 style="margin: 0; font-size: 24px; line-height: 36px; font-weight: 700; padding-top: 30px; padding-bottom: 20px; color: #384860;"><?php echo esc_html( $args['achievement_title'] ); ?></h1>
            <div style="font-size: 16px; padding-bottom: 50px; color: #384860;"><?php echo wp_kses_post( $args['achievement_message'] ); ?></div>
        </td>
    </tr>
    <tr>
        <td align="center" valign="top" class="mesage-content">
            <div class="message" style="padding-top: 40px; padding-bottom: 40px; padding-left: 40px; padding-right: 40px; background-color: #ECF8F4; border-radius: 10px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="10%" align="left" valign="top">
                            <img src="<?php echo esc_url( $celebrate_icon_1 ); ?>" alt="Light Icon" style="padding-right: 10px;" />
                        </td>
                        <td width="90%" align="left" valign="middle">
                            <h3 style="font-size: 16px; font-weight: 700; color: #384860; margin: 0;"><?php echo esc_html( $args['celebrate_row1_title'] ); ?></h3>
                        </td>
                    </tr>
                    <tr>
                        <td width="95%" align="left" valign="top" colspan="2">
                            <div style="font-size: 16px; padding-left: 30px; padding-top: 15px; padding-bottom: 30px; color: #384860;">
                    ...
                    <tr>
                        <td width="10%" align="left" valign="top">
                            <img src="<?php echo esc_url( $celebrate_icon_2 ); ?>" alt="Light Icon" style="padding-right: 10px;" />
                        </td>
                        <td width="90%" align="left" valign="middle">
                            <h3 style="font-size: 16px; font-weight: 700; color: #384860; margin: 0;"><?php echo esc_html( $args['celebrate_row2_title'] ); ?></h3>
                        </td>
                    </tr>
                    <tr>
                        <td width="95%" align="left" valign="top" colspan="2">
                            <div style="font-size: 16px; padding-left: 30px; padding-top: 15px; padding-bottom: 30px;">
                                <ul style="list-style-type: disc;padding-left: 20px; color: #384860;">
                    ...
                    <tr>
                        <td width="10%" align="left" valign="top">
                            <img src="<?php echo esc_url( $celebrate_icon_3 ); ?>" alt="Light Icon" style="padding-right: 10px;" />
                        </td>
                        <td width="90%" align="left" valign="middle">
                            <h3 style="font-size: 16px; font-weight: 700; color: #384860; margin: 0;"><?php echo esc_html( $args['celebrate_row3_title'] ); ?></h3>
                        </td>
                    </tr>
                    <tr>
                        <td width="95%" align="left" valign="top" colspan="2">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="center" valign="middle" style="font-size: 16px; color: #384860;">
